...
?>
    <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/<?php echo $language; ?>/sdk.js#xfbml=1&version=v5.0&appId=<?php echo $app_id; ?>&autoLogAppEvents=1">
